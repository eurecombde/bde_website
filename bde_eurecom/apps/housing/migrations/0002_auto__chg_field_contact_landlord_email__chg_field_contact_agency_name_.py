...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.landlord_email'
        db.alter_column(u'housing_contact', 'landlord_email', self.gf('django.db.models.fields.CharField')(max_length=70, null=True))

        # Changing field 'Contact.agency_name'
        db.alter_column(u'housing_contact', 'agency_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
        # Adding field 'House.available'
        db.add_column(u'housing_house', 'available',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'House.accomodation_type_other'
        db.alter_column(u'housing_house', 'accomodation_type_other', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'House.accomodation_name'
        db.alter_column(u'housing_house', 'accomodation_name', self.gf('django.db.models.fields.CharField')(default=0, unique=True, max_length=30))

        # Changing field 'Room.other_type'
        db.alter_column(u'housing_room', 'other_type', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Location.city'
        db.alter_column(u'housing_location', 'city', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Location.distance_eurecom'
        db.alter_column(u'housing_location', 'distance_eurecom', self.gf('django.db.models.fields.FloatField')(default=2))

        # Changing field 'Location.address'
        db.alter_column(u'housing_location', 'address', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Contact.landlord_email'
        db.alter_column(u'housing_contact', 'landlord_email', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'Contact.agency_name'
        db.alter_column(u'housing_contact', 'agency_name', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
        # Deleting field 'House.available'
        db.delete_column(u'housing_house', 'available')


        # Changing field 'House.accomodation_type_other'
        db.alter_column(u'housing_house', 'accomodation_type_other', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'House.accomodation_name'
        db.alter_column(u'housing_house', 'accomodation_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=30, null=True))

        # Changing field 'Room.other_type'
        db.alter_column(u'housing_room', 'other_type', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Location.city'
        db.alter_column(u'housing_location', 'city', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Location.distance_eurecom'
        db.alter_column(u'housing_location', 'distance_eurecom', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Location.address'
        db.alter_column(u'housing_location', 'address', self.gf('django.db.models.fields.CharField')(max_length=30))
